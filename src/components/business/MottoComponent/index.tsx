...
@inject("userStore")
@observer
class MottoComponent extends React.Component<IMottoComponentPropType, IMottoComponentStateType> {
	...
	render() {
		...
		return <CommonWrapComponent
			...
			render={isEditing => <Row>
				...
				<Col>
					{
						enError && <Text type="danger">短句不能为空</Text>
					}
				</Col>
				<Col>
					<CommonGap size='sm'/>
				...
				<Col>
					{
						zhError && <Text type="danger">座右铭不能为空</Text>
					}
				</Col>
				<Col>
					<CommonGap size='sm'/>
				...
				<Col>
					{
						introError && <Text type="danger">简介不能为空</Text>
					}
				</Col>
			</Row>}
		/>;
