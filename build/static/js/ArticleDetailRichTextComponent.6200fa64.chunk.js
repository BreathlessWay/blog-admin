			...
			var d = (function() {
				var e = Object(i.a)(
					n.a.mark(function e(t) {
						var a, r, i, c, l, d, p, h, f, v, m, b, g, w;
						return n.a.wrap(
							function(e) {
								for (;;)
									switch ((e.prev = e.next)) {
										...
										case 12:
											return h.append('file', a), (e.next = 15), u(h);
										case 15:
											if (
												((v = e.sent),
							...
							(y = (function(e) {
								function t() {
									...
									return (
										((a = Object(i.a)(
											this,
											(e = Object(c.a)(t)).call.apply(e, [this].concat(l)),
										...
										(a.handleEditorChange = function(e) {
											var t = a.props.articleDetailStore,
												...
												o = t.detail;
											r({
												key: f.b.contentError,
												value:
													!e.toText() &&
													(null === o || void 0 === o
														? void 0
														: o.renderType) === f.c.richText,
											}),
												n({ key: f.a.draftDetail, value: e });
										}),
										(a.handleUploadFile = function(e) {
											/^(image)/g.test(e.file.type)
												? Object(m.a)({ file: e.file, size: v.d })
														.then(function(t) {
															var a = t.url,
																r = t.title;
															e.success({
