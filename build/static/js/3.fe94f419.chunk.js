	...
	[3],
	{
		...
		436: function(e, t, n) {
			...
			var O = h,
				...
				R = (A(['flex', 'webkitFlex', 'Flex', 'msFlex']), A),
				I = n(14),
				V = n(514),
				K = n(98),
				U = n(542);
			...
			var W = (function(e) {
				function t() {
					...
					return (
						H(this, t),
						((e = B(this, F(t).apply(this, arguments))).inComposition = !1),
						(e.state = { current: '' }),
				...
				return (
					...
					(r = [
						...
						},
						{
							...
							value: function() {
								window.clearTimeout(this.copyId), D.a.cancel(this.rafId);
							},
						},
						{
							key: 'getEditable',
			...
			function H(e) {
				...
				if (
					...
					var n = (function(e, t) {
						...
						r = n.picked,
						i = n.omitted,
						a = L(L({ display: 'inline-block' }, r), {
							cursor: 'not-allowed',
							width: e.props.block ? '100%' : null,
						}),
						l = L(L({}, i), { pointerEvents: 'none' }),
			...
			var z = (function(e) {
				function t(e) {
					...
					return (
						...
						(i = V(t).call(this, e)),
						((n =
							!i || ('object' !== R(i) && 'function' !== typeof i)
								? K(r)
						...
						(n.renderTooltip = function(e) {
							...
							return o.createElement(
								...
								d ? o.cloneElement(v, { className: O }) : v,
							);
						}),
				...
				return (
					...
					(r = [
										...
										return (
											Object.keys(c).forEach(function(t) {
												(c[t] = e.arrowPointAtCenter
													? T(T({}, c[t]), { overflow: D(s), targetOffset: _ })
													: T(T({}, C[t]), { overflow: D(s) })),
													(c[t].ignoreShake = !0);
											}),
											c
										);
						...
						},
						{
							key: 'render',
							value: function() {
								return o.createElement(A.a, null, this.renderTooltip);
							},
						},
					]) && I(n.prototype, r),
					i && I(n, i),
