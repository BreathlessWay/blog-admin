	...
	[1],
	{
		462: function(t, e, o) {
			...
			function Q(t, e, o) {
				...
				Y(t, f), X(t), ('left' in e || 'top' in e) && j(t, l);
				var y = {};
				for (var b in e)
			...
			function ft(t) {
				...
				if (!('fixed' === n || 'absolute' === n))
					return 'html' === t.nodeName.toLowerCase() ? null : ht(t);
				for (e = ht(t); e && e !== o && 9 !== e.nodeType; e = ht(e))
			...
			function mt(t) {
				...
				var p = ct.getWindowScrollLeft(i),
					...
					h = ct.viewportHeight(i),
					f = s.scrollWidth,
					d = s.scrollHeight,
					m = window.getComputedStyle(r);
				if (
					('hidden' === m.overflowX && (f = i.innerWidth),
					...
					(e.left = Math.max(e.left, p)),
						...
						(e.bottom = Math.min(e.bottom, l + h));
				else {
					var g = Math.max(f, p + c);
					e.right = Math.min(e.right, g);
					var v = Math.max(d, l + h);
			...
			function xt(t, e, o, n) {
				...
				if (c && (a.adjustX || a.adjustY) && n) {
					if (a.adjustX && bt(f, h, c)) {
						var m = Ct(i, /[lr]/gi, { l: 'r', r: 'l' }),
							g = Tt(r, 0),
							v = Tt(s, 0);
						(function(t, e, o) {
							return t.left > o.right || t.left + e.width < o.left;
						})(yt(h, e, m, g, v), h, c) || ((l = 1), (i = m), (r = g), (s = v));
					}
					if (a.adjustY && wt(f, h, c)) {
						var y = Ct(i, /[tb]/gi, { t: 'b', b: 't' }),
							b = Tt(r, 1),
							w = Tt(s, 1);
						(function(t, e, o) {
							return t.top > o.bottom || t.top + e.height < o.top;
						})(yt(h, e, y, b, w), h, c) || ((l = 1), (i = y), (r = b), (s = w));
					}
					l && ((f = yt(h, e, i, r, s)), ct.mix(d, f));
					var C = bt(f, h, c),
						T = wt(f, h, c);
					(C || T) &&
						((i = o.points),
				...
				return (
					d.width !== h.width &&
						ct.css(u, 'width', ct.width(u) + d.width - h.width),
					d.height !== h.height &&
						ct.css(u, 'height', ct.height(u) + d.height - h.height),
					ct.offset(
						u,
			...
			(Ot.__getOffsetParent = ft), (Ot.__getVisibleRectForElement = mt);
			function kt(t) {
				...
				Lt = (function(t) {
					...
					return (
						...
						(e.prototype.render = function() {
							...
							return e || h.a.Children.count(n.children) > 1
								? (!o && e && (n.className += ' ' + e),
								  h.a.createElement('div', n))
								: h.a.Children.only(n.children);
						}),
						e
					);
				})(c.Component);
					...
					return (
						...
						(e.prototype.getPopupElement = function() {
							var t = this,
								...
								b = a.onMouseDown,
								w = a.onTouchStart,
								C = this.getClassName(this.currentAlignClassName || f(u)),
								T = l + '-hidden';
								...
								? h.a.createElement(
										...
										p
											? h.a.createElement(
													...
													h.a.createElement(Xt, i()({ visible: !0 }, P), g),
											  )
											: null,
								  )
								: h.a.createElement(
										...
										h.a.createElement(
											...
											h.a.createElement(Xt, i()({ hiddenClassName: T }, P), g),
										),
								  );
						}),
