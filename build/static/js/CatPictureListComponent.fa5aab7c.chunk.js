	...
	[21],
	{
			...
			var N = function(e, t) {
				...
				I = (function(e) {
					function t() {
						...
						return (
							_(this, t),
							((e = P(this, S(t).apply(this, arguments))).state = {
								visible: !1,
							}),
							...
							},
							{
								...
								value: function() {
									var e = this.props,
										...
										u = l && this.getIcon(),
										f = i()(n, t, M({}, ''.concat(n, '-').concat(c), !!c));
									return o.createElement(
										r.a,
										C({}, Object(j.a)(s, ['suffix']), {
		...
		444: function(e, t, n) {
			...
			t.a = Object(w.a)(Object(E.b)('globalStore'), E.c)(function(e) {
										...
										for (;;)
											switch ((e.prev = e.next)) {
												case 0:
													...
													return w.startLoading(), (e.next = 5), s();
												case 5:
													i(!1);
												case 6:
													a || i(!0), (e.next = 12);
												...
												case 12:
													return (e.prev = 12), w.endLoading(), e.finish(12);
												case 15:
												case 'end':
													return e.stop();
											}
				...
				return o.a.createElement(
					...
					o.a.createElement(h.a, null, k ? k(a) : l),
					o.a.createElement(h.a, null, o.a.createElement(O.a, { size: 'xl' })),
				);
			});
		},
		445: function(e, t) {
		...
		461: function(e, t, n) {
			...
			(d.defaultProps = { status: 'info' }),
				(d.PRESENTED_IMAGE_403 = f[403]),
				(d.PRESENTED_IMAGE_404 = f[404]),
				(d.PRESENTED_IMAGE_500 = f[500]);
			var h = d,
				m = n(11),
				v = n(12),
				y = n(35),
			...
			var f = (function() {
				var e = Object(i.a)(
					o.a.mark(function e(t) {
						var n, r, i, c, l, f, p, d, h, m, v, y, b, g;
						return o.a.wrap(
							function(e) {
								for (;;)
									switch ((e.prev = e.next)) {
										...
										case 27:
											return (e.prev = 27), f(), e.finish(27);
										case 30:
										case 'end':
											return e.stop();
									}
		...
		521: function(e, t, n) {
			...
			e.exports = function(e, t, n, d, h, m) {
				...
				if (!(1 & n)) {
					var w = k && p.call(e, '__wrapped__'),
						j = E && p.call(t, '__wrapped__');
					if (w || j) {
						var x = w ? e.value() : e,
							C = j ? t.value() : t;
						return m || (m = new r()), h(x, C, n, d, m);
					}
				}
		...
		527: function(e, t, n) {
			...
			e.exports = function(e, t, n, a, i, c) {
				...
				for (var m = l; ++f < u; ) {
					var v = e[(p = s[f])],
						y = t[p];
					if (a) var b = l ? a(y, v, p, t, e, c) : a(v, y, p, e, t, c);
				...
				return (
					...
					i.a.createElement(
						...
						i.a.createElement(
							...
							i.a.createElement(c.a, { url: t, height: p, observer: v }),
						),
						m &&
							i.a.createElement(
								'section',
						...
						(t.prototype.render = function() {
							var e,
								...
								w = b()(
									n,
									r,
									(((e = {})[n + '-checked'] = O), (e[n + '-disabled'] = u), e),
								);
		...
		574: function(e, t, n) {
				...
				return (
					...
					f()(t, [
						...
						},
						{
							key: 'getComponent',
							value: function() {
								return 'undefined' !== typeof File ? P : B;
							},
						},
						{
							key: 'abort',
			...
			var he = function(e) {
					return (function(e) {
						function t() {
							return le(this, t), ue(this, pe(t).apply(this, arguments));
						}
						var n, r, o;
						return (
							(function(e, t) {
							...
							(r = [
								...
								},
								{
									key: 'render',
									value: function() {
										return fe(pe(t.prototype), 'render', this).call(this);
									},
								},
							]) && se(n.prototype, r),
							o && se(n, o),
			...
			var Me = (function(e) {
				function t() {
					...
					return (
						Ce(
							je((n = Oe(this, (e = we(t)).call.apply(e, [this].concat(o))))),
							'paths',
							{},
						),
						n
			...
			(Ue.propTypes = Fe({}, ye, {
				...
				(Ue.defaultProps = Fe({}, me, { gapPosition: 'top' }));
			var Re = he(Ue);
			var Ve = { normal: '#108ee9', exception: '#ff5500', success: '#87d068' };
			function He(e) {
				var t = e.percent,
					n = e.successPercent,
					r = ne(t);
			...
			var qe = function(e) {
				var t,
					...
					v = c || 6,
					y = u || ('dashboard' === p && 'bottom') || 'top',
					b = f || ('dashboard' === p ? 75 : void 0),
					g = (function(e) {
						var t = e.progressStatus,
							n = e.successPercent,
							r = e.strokeColor || Ve[t];
						return n ? [Ve.success, r] : r;
					})(e),
						...
						return (
							...
							((e = Ye(
								...
								'line' === u
									? (o = r.createElement(
											ce,
											Ke({}, e.props, { prefixCls: d }),
											m,
									  ))
									: ('circle' !== u && 'dashboard' !== u) ||
									  (o = r.createElement(
											qe,
											Ke({}, e.props, { prefixCls: d, progressStatus: h }),
											m,
									  ));
								var v = E()(
									d,
									...
									$e(n, ''.concat(d, '-status-').concat(h), !0),
									$e(n, ''.concat(d, '-show-info'), f),
									$e(n, ''.concat(d, '-').concat(s), s),
									n),
									l,
								);
								return r.createElement(
						...
						(e.renderUploadList = function(t) {
							var n,
								...
								v = l.map(function(t) {
									...
									var M = r.createElement('span', null, i, j),
										_ = r.createElement(
											'div',
											{ className: y },
											r.createElement(
			...
			var xt = (function(e) {
				function t(e) {
					...
					return (
						...
						((n = Ot(this, wt(t).call(this, e))).saveUpload = function(e) {
							n.upload = e;
						}),
						...
						(n.beforeUpload = function(e, t) {
							...
							return !1 === a
								? (n.onChange({
										file: e,
										fileList: R()(o.concat(t.map($)), function(e) {
											return e.uid;
										}),
								  }),
								  !1)
						...
						(n.renderUpload = function(e) {
							...
							var w = E()(
								...
								gt(t, ''.concat(y, '-disabled'), f),
								t),
							);
							(p && !f) || delete b.id;
							var j = r.createElement(
								'div',
								{ className: w, style: p ? void 0 : { display: 'none' } },
								r.createElement(W, kt({}, b, { ref: n.saveUpload })),
							);
							return 'picture-card' === s
								...
								: r.createElement('span', { className: c }, j, g);
						}),
						(n.state = {
			...
			var Dt = (function(e) {
				function t() {
					return Ft(this, t), St(this, Lt(t).apply(this, arguments));
				}
				var n, o, a;
				return (
					(function(e, t) {
								...
								E &&
									((j.onChange = function() {
										g.onChange && g.onChange.apply(g, arguments),
											E.toggleOption({ label: p, value: i.value });
									}),
									(j.name = E.name),
									(j.checked = -1 !== E.value.indexOf(i.value)),
									(j.disabled = i.disabled || E.disabled));
								var x = c()(
										f,
									...
									C = c()(h({}, ''.concat(w, '-indeterminate'), d));
								return r.createElement(
									'label',
									{ className: x, style: v, onMouseEnter: y, onMouseLeave: b },
									r.createElement(
										l.a,
										m({}, j, {
											prefixCls: w,
						...
						c &&
							u.map(function(e, t) {
								return a.a.createElement(
									...
									f({ item: e, index: t, observer: c }),
								);
							}),
						a.a.createElement('li', { className: m }, p),
					)
				);
			};
		},
		...
		617: function(e, t, n) {
			...
			var r = n(138),
				...
				a = n.n(o),
				i = function() {
					return a.a.get('/cat/figure');
				},
				c = function(e) {
					return a.a.post('/cat/figure', e);
				},
				l = function(e) {
					var t = e._id,
						n = Object(r.a)(e, ['_id']);
					return a.a.put('/cat/figure/'.concat(t), n);
				},
				s = function(e) {
					return a.a.delete('/cat/figure/'.concat(e));
				},
				u = function(e) {
					return a.a.get('/cat/list?'.concat(e));
				},
				f = function(e) {
					return a.a.post('/cat/list', { list: e });
				},
				p = function(e) {
					var t = e._id,
						n = Object(r.a)(e, ['_id']);
					return a.a.put('/cat/list/'.concat(t), n);
				},
				d = function(e) {
					return a.a.delete('/cat/list/'.concat(e));
				},
				h = function(e) {
					return a.a.put('/cat/list', e);
				},
				m = function(e) {
					return a.a.delete('/cat/list?ids='.concat(JSON.stringify(e)));
				};
		},
		800: function(e, t, n) {
			'use strict';
		...
		915: function(e, t, n) {
			...
			var r,
				...
				S = n(617),
				L = n(19),
				N = (n(916), E.a.TextArea),
				D = k.a.confirm,
				I = { fontSize: L.a },
				A =
					Object(j.b)(function(e) {
						return { catStore: e.catStore, homepageStore: e.homepageStore };
					})(
						(r =
							Object(j.c)(
								(r = (function(e) {
									function t() {
										...
										return (
											...
											(n.onAddCatPicture = (function() {
												var e = Object(h.a)(
													p.a.mark(function e(t) {
														var r, o, a, i, c, l, s, u, f, h, m;
														return p.a.wrap(
															function(e) {
																for (;;)
																	switch ((e.prev = e.next)) {
																		...
																		case 22:
																			return (e.prev = 22), c(), e.finish(22);
																		case 25:
																		case 'end':
																			return e.stop();
																	}
											...
											(n.handlePreview = function(e) {
												return function() {
													n.urls[e] && F.a.show({ urls: n.urls, index: e });
												};
											}),
											(n.handleRemove = function(e) {
												return function() {
															...
															for (;;)
																switch ((e.prev = e.next)) {
																	case 0:
																		...
																		return (e.next = 6), n.changeInfo(t);
																	case 6:
																		e.next = 10;
																		break;
																	case 8:
											...
											(n.handleEditIntro = function(e) {
												var t = n.state.editItem;
												t &&
													((t.intro = e.target.value),
													n.setState({ editItem: t }));
											}),
											(n.handleEditTitle = function(e) {
												var t = n.state.editItem;
												t &&
													((t.title = e.target.value),
													n.setState({ editItem: t }));
											}),
											(n.handleChangeSwitch = function() {
												var e = n.state.editItem;
												e && ((e.show = !e.show), n.setState({ editItem: e }));
											}),
											(n.handleChangeChecked = function(e) {
												return function() {
													n.props.catStore.setItem(
									...
									return (
										...
										Object(v.a)(t, [
											...
											},
											{
												...
												value: function() {
													var e = this,
														...
														r = t.confirmLoading,
														f = t.editItem,
														p = this.props.catStore,
														d = p.list,
														h = p.loading,
														m = this.props.homepageStore.catAlias;
																	...
																	render: function(t) {
																		...
																		return w.a.createElement(
																			...
																			w.a.createElement(s.a, {
																				...
																				onChange: e.handleChangeChecked(n),
																				checked: n.checked,
																			}),
																			w.a.createElement(C.a, {
																				onClick: e.handleChangeChecked(n),
																				observer: o,
																				width: 300,
																				height: 200,
																				showInfo: !0,
																				...
																				actions: [
																					...
																					w.a.createElement(l.a, {
																						...
																						onClick: e.handleSetShowFigure(n),
																					}),
																				],
																			}),
																		);
											...
											},
											{
												key: 'urls',
												get: function() {
													return this.props.catStore.list.map(function(e) {
														return e.url;
													});
												},
											},
