	...
	[4],
	{
		...
		432: function(e, t, n) {
										...
										value: function() {
											...
											return u
												? 'none' !== n && o(this.props)
													...
													: l
													? null
													: u($()({}, d, { className: f }), this.setNodeRef)
												: null;
										},
									},
								],
			...
			var Ke = 0,
				...
				Ie = (function(e) {
					function t(e) {
						...
						!(function(e, t) {
							...
							(n.onKeyDown = function(e) {
								var t = e.keyCode,
									...
									u = r.store;
								if (t === a.a.ENTER)
									return n.onTitleClick(e), xe(u, n.props.eventKey, !0), !0;
								if (t === a.a.RIGHT)
									return (
										i
											? o.onKeyDown(e)
											: (n.triggerOpenChange(!0), xe(u, n.props.eventKey, !0)),
										!0
									);
								if (t === a.a.LEFT) {
									var s;
						...
						var u = e.store,
							s = e.eventKey,
							c = u.getState().defaultActiveFirst;
						n.isRootMenu = !1;
						var l = !1;
						return c && (l = c[s]), xe(u, s, l), n;
					}
					var n, r, i;
					return (
						(function(e, t) {
					...
					return (
						...
						(e.getOverflowedSubMenuItem = function(t, n, r) {
							var i = e.props,
								...
								c = i.prefixCls,
								l = i.theme;
							if (1 !== u || 'horizontal' !== s) return null;
					...
					return (
								...
								p = ot(
									{
										...
										manualRef: c.disabled
											? void 0
											: Object(u.a)(e.ref, st.bind(et(n))),
										eventKey: s,
										active: !c.disabled && l,
										multiple: a.multiple,
										onClick: function(e) {
											(c.onClick || T)(e), n.onClick(e);
										},
						...
						e.store.setState({
							activeKey: ot(
								...
								rt({}, e.eventKey, ut(e, e.activeKey)),
							),
						}),
						(n.instanceArray = []),
						n
			...
			var At = (function(e) {
				function t() {
					...
					return (
						Dt(this, t),
						((e = It(this, Tt(t).apply(this, arguments))).onKeyDown = function(
							t,
						) {
			...
			e.exports = function(e, t, n) {
				...
				f
					? ((S = t),
					  ...
					  (O = { left: d.left - j.left - c, top: d.top - j.top - s }),
					  (w = {
		...
		584: function(e, t, n) {
				...
				for (i = 0; i < t.length; i++)
					if ((r = t[i]))
						for (a = 0; a < n.length; a++) {
							var u = void 0;
							(u = 'border' === r ? r + n[a] + 'Width' : r + n[a]),
								(o += parseFloat(p(e, u)) || 0);
						}
				return o;
			}
			function h(e) {
			...
			function g(e, t, n) {
				...
				var u = void 0 !== r || i,
					s = r || a;
				if (-1 === n) return u ? s - b(e, ['border', 'padding'], o) : a;
				if (u) {
								...
								},
								{
									...
									value: function(e, t) {
										return (
											...
											!(0, u.default)(this.state.subscribed, t.subscribed)
										);
									},
								},
								{
					...
					function o(t, o) {
						...
						return function(c) {
							...
							o.a &&
								...
								t.nodeValue !== u.a &&
								c.push(
									new n({ type: 'characterData', target: t, oldValue: u.a }),
								),
								o.b && u.b && r(c, t, u.b, o.f),
								(o.c || o.g) &&
									(l = (function(t, o, i, u) {
								...
								(l || c.length !== p) && (u = i(t, o));
						};
					}
					function r(t, o, r, i) {
						for (var a, u, s = {}, c = o.attributes, p = c.length; p--; )
							(u = (a = c[p]).name),
								(i && i[u] === e) ||
									(l(o, a) !== r[u] &&
										t.push(
							...
							return (
								!t.a || (3 !== o.nodeType && 8 !== o.nodeType)
									? (t.b &&
											n &&
											1 === o.nodeType &&
											(r.b = u(o.attributes, function(e, n) {
												return (
					...
					(t._period = 30),
						(t.prototype = {
							observe: function(e, n) {
								...
								n.attributeFilter &&
									(r.f = u(n.attributeFilter, function(e, t) {
										return (e[t] = !0), e;
									})),
									i.push({ s: e, o: o(e, r) }),
									this.h ||
